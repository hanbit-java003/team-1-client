...
INSERT INTO `cc_alert_rest` VALUES (0,0,'2XlRehENs3kP','너무 기다리게 합니다','N');
...
CREATE TABLE `cc_bookmark` (
  ...
  `rid` int(11) NOT NULL,
  KEY `fk_cc_bookmark_cc_member1_idx` (`uid`),
  KEY `fk_cc_bookmark_cc_rest1_idx` (`rid`),
...
INSERT INTO `cc_bookmark` VALUES ('2XlRehENs3kP',12),('2XlRehENs3kP',11),('2XlRehENs3kP',10),('2XlRehENs3kP',9),('2XlRehENs3kP',8),('2XlRehENs3kP',7),('2XlRehENs3kP',13);
/*!40000 ALTER TABLE `cc_bookmark` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cc_bookmark_review`
--

DROP TABLE IF EXISTS `cc_bookmark_review`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cc_bookmark_review` (
  `rid` int(11) NOT NULL,
  `review` varchar(200) DEFAULT NULL,
  KEY `rid_idx` (`rid`),
  CONSTRAINT `rid` FOREIGN KEY (`rid`) REFERENCES `cc_rest` (`rid`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cc_bookmark_review`
--

LOCK TABLES `cc_bookmark_review` WRITE;
/*!40000 ALTER TABLE `cc_bookmark_review` DISABLE KEYS */;
INSERT INTO `cc_bookmark_review` VALUES (0,'신촌쌀국수 맛집으로 유명한 미분당 베트남쌀국수'),(1,'신촌역 마루가메 제면에서 맛있는 우동과 튀김'),(2,'지하철 2호선보다 오래된 순대 족발 보쌈'),(3,'화교가 운영하는 중국집. 음식이 일반적인 중화요리보다 맛과 향이 강한 편. 대표메뉴인 탕수육은 보통 탕수육보다 훨씬 더 달콤한 편이지만, 전혀 느끼하지 않다. 단맛이 가미된 쟁반짜장도 유명하다.'),(4,'신촌 저렴한 맛집 함박집! 크림 함박 스테이크, 치즈 듬뿍 함박 스테이크'),(5,'카레 덕후 중독 증상'),(6,'진득한 육수의 제대로 된 역대급 일본라멘'),(7,'간장마늘치킨과 강렬했던 신촌맥주'),(8,'오징어볶음과 고등어구이가 맛있는 신촌 맛집'),(9,'도전 대왕돈까스로 유명한 이대 돈까스'),(10,'메뉴 고르느라 고민할 필요없는 불백'),(11,'유케동이 맛있는 돈부리 맛집'),(12,'신촌 중국집에서 먹은 맛있는 짬뽕'),(13,'태국 요리점 방콕 익스프레스에서 맛있는 팟타이');
/*!40000 ALTER TABLE `cc_bookmark_review` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `cc_like` (
  ...
  `article_id` int(11) NOT NULL,
  `uid` varchar(200) NOT NULL,
  PRIMARY KEY (`rid`,`article_id`,`uid`),
  KEY `fk_cc_like_cc_article1_idx` (`article_id`,`rid`),
  KEY `fk_cc_like_cc_member1_idx` (`uid`),
  CONSTRAINT `fk_cc_like_cc_article1` FOREIGN KEY (`article_id`, `rid`) REFERENCES `cc_article` (`article_id`, `rid`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_cc_like_cc_member1` FOREIGN KEY (`uid`) REFERENCES `cc_member` (`uid`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cc_like`
--

LOCK TABLES `cc_like` WRITE;
/*!40000 ALTER TABLE `cc_like` DISABLE KEYS */;
/*!40000 ALTER TABLE `cc_like` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `cc_member` (
  ...
  `master` varchar(5) NOT NULL DEFAULT 'N',
  `bann` varchar(45) NOT NULL DEFAULT 'N',
  PRIMARY KEY (`uid`),
...
INSERT INTO `cc_member` VALUES ('2XlRehENs3kP','kch3338@naver.com','마블리','4bb995e9f4a0de4cc1eb9c9a593124186be27824e5a04d7a0e3c3c21258e85011a2836c818df0a24','2017-10-24 10:21:15',NULL,'Y','N'),('75FTQ69HMRYd','qwer@qwer.com','qwer맨','ce35282346b5ab89920b3b0df1eee77588b4634c2eb8f1234800f7e9b5c9d79fddad4d95904d5aaf','2017-10-26 11:37:27',NULL,'N','N'),('7k0OieLy05Ni','1234@naver.com','장첸','ca95d555095f9f0632f97d1d9c9d07fed94b82d8f2d8958e91d68eb99d94c041697b2fda8985cd46','2017-11-16 09:23:43',NULL,'Y','N'),('rwyA5DgoUnKc','jmkjmk0629@naver.com','냐옹이','da5958154b7236b86da30fbe2d929c4db25f99eed061f773697a96903867fce575e50fee1ae77052','2017-11-10 12:44:42',NULL,'N','N');
...
INSERT INTO `cc_member_detail` VALUES ('2XlRehENs3kP','01074109274','Y','/api/file/avatar-2XlRehENs3kP',NULL),('75FTQ69HMRYd','','N','/api/file/avatar-75FTQ69HMRYd',NULL),('7k0OieLy05Ni','','N','/api/file/avatar-7k0OieLy05Ni',NULL),('rwyA5DgoUnKc','','Y',NULL,NULL);
...
INSERT INTO `cc_rest` VALUES (0,37.55662605051876,126.93523351103067,'미분당 신촌2호점',NULL),(1,37.55568647486719,126.93621134385467,'마루가메제면 신촌점',NULL),(2,37.556472954982894,126.9363583624363,'구월산',NULL),(3,37.55244557889617,126.93810448050499,'홍원',NULL),(4,37.558996864846385,126.93616256117821,'함박집',NULL),(5,37.55404464761884,126.93777725100517,'거북이의주방',NULL),(6,37.555353965907464,126.93269480019808,'고라멘',NULL),(7,37.55806343215456,126.93474367260933,'크리스터치킨',NULL),(8,37.55826117627507,126.93469472229481,'고삼이',NULL),(9,37.55632942763234,126.93711005151272,'돈까스대왕전',NULL),(10,37.551452522938504,126.9373507797718,'마포돼지불백',NULL),(11,37.554631531255524,126.93834587931633,'돈부리모노 2호점',NULL),(12,37.557291587178696,126.93784967064857,'갑이다짬뽕',NULL),(13,37.5571459350951,126.94187633693218,'방콕익스프레스 신촌2호점',NULL),(14,37.54127665833384,126.94720387458801,'맛집테스트',NULL);
...
INSERT INTO `cc_rest_detail` VALUES (0,'서울특별시 서대문구 신촌동 연세로5길 26-7','02-3141-9494','11:00 ~ 15:00, 17:00 ~ 21:00','차돌 양지 쌀국수','영업','/api/file/photo-rest-0'),(1,'서울특별시 서대문구 신촌동 신촌로 87-4','02-3144-3967','오전 11:00 ~ 오후 11:30','가케우동','영업','/api/file/photo-rest-1'),(2,'서울 서대문구 신촌로 87-22','02-336-2069','00:00 - 24:00','왕순대국밥','영업','/api/file/photo-rest-2'),(3,'서울특별시 마포구 백범로 23 (신수동)','02-704-9667','11:00 - 21:00','간짜장','영업','/api/file/photo-rest-3'),(4,'서울 서대문구 연세로11길 12','02-326-5830','11:00 ~ 21:00 일요일 휴무','치즈듬뿍 함박','영업','/api/file/photo-rest-4'),(5,'서울특별시 마포구 백범로1길 8-7(노고산동, 31-50) 지하 1층','02-701-0890','오전 10:00~오후 11:30','거북이 카레','영업','/api/file/photo-rest-5'),(6,'서울특별시 마포구 노고산동 54-80','02-336-8599','12:00 ~ 21:00 월,화 휴무','고라멘','영업','/api/file/photo-rest-6'),(7,'서울특별시 서대문구 창천동 53-19','02-324-9200','16:00 - 02:00','핫치킨','영업','/api/file/photo-rest-7'),(8,'서울특별시 서대문구 창천동 53-8','02-324-1403','오전 11:00~오후 10:00','고등어구이','영업','/api/file/photo-rest-8'),(9,'서울 서대문구 연세로 10','02-393-7772','11:00 - 22:00','대왕돈까스','영업','/api/file/photo-rest-9'),(10,'서울특별시 마포구 대흥동 백범로 36','02-2604-2300','10:00 ~ 20:30 일요일 휴무','돼지불백','영업','/api/file/photo-rest-10'),(11,'서울특별시 마포구 노고산동 33-19','02-703-8231','오전 11:00~오후 10:00','유케동','영업','/api/file/photo-rest-11'),(12,'서울특별시 서대문구 신촌동 연세로4길 19','02-312-2833','오전 11:00~오후 9:00','갑이다짬뽕','영업','/api/file/photo-rest-12'),(13,'서울 서대문구 연세로2길 93-7','02-6401-7793','11:30 - 15:00, 17:30 - 22:00','뿌팟퐁커리','영업','/api/file/photo-rest-13');
...
INSERT INTO `cc_tag` VALUES (0,0,0,'쌀국수'),(0,1,0,'우동'),(0,2,0,'순대국'),(0,3,0,'중식'),(0,4,0,'함박스테이크'),(0,4,1,'함박스테이크'),(0,4,2,'함박집'),(0,5,0,'카레'),(0,6,0,'고라멘'),(0,6,1,'고라멘'),(0,6,2,'고라멘'),(0,6,3,'고라멘'),(0,6,4,'쇼유라멘'),(0,6,5,'쇼유라멘'),(0,7,0,'치킨'),(0,8,0,'고삼이'),(0,9,0,'돈까스대왕전'),(0,10,0,'돼지불백'),(0,11,0,'가라아게동'),(0,12,0,'짬뽕'),(0,12,1,'백짬뽕'),(0,13,0,'팟타이'),(0,13,1,'방콕익스프레스'),(0,13,2,'새우볶음밥'),(0,13,3,'쌀국수'),(0,14,0,'고양이'),(1,0,0,'미분당'),(1,1,0,'신촌맛집'),(1,2,0,'족발'),(1,3,0,'짜장면'),(1,4,0,'신촌맛집'),(1,4,1,'신촌맛집'),(1,4,2,'신촌맛집'),(1,5,0,'신촌맛집'),(1,6,0,'라멘'),(1,6,1,'신촌맛집'),(1,6,2,'돈코츠라멘'),(1,6,3,'돈코츠라멘'),(1,6,4,'고라멘'),(1,6,5,'라멘'),(1,7,0,'신촌맛집'),(1,8,0,'신촌맛집'),(1,9,0,'신촌맛집'),(1,10,0,'신촌맛집'),(1,12,0,'갑이다짬뽕'),(1,12,1,'짬뽕'),(1,13,0,'태국음식'),(1,13,1,'태국요리'),(1,13,2,'태국요리'),(1,13,3,'방콕익스프레스'),(1,14,0,'입니다'),(2,0,0,'신촌맛집'),(2,1,0,'일본우동'),(2,2,0,'보쌈'),(2,3,0,'신촌맛집'),(2,6,0,'신촌맛집'),(2,6,1,'일본라멘'),(2,6,2,'신촌맛집'),(2,6,3,'일본라멘'),(2,6,4,'신촌맛집'),(2,6,5,'고라멘'),(2,7,0,'크림피넛치킨'),(2,8,0,'생선구이'),(2,9,0,'대왕돈까스'),(2,10,0,'서강대맛집'),(2,12,0,'신촌맛집'),(2,12,1,'갑이다짬뽕'),(2,13,0,'방콕익스프레스'),(2,13,1,'꿍팟커리'),(2,13,2,'방콕익스프레스'),(2,13,3,'신촌맛집'),(3,2,0,'구월산'),(3,6,0,'돈코츠라멘'),(3,6,3,'신촌맛집'),(3,12,1,'신촌맛집'),(3,13,0,'신촌맛집'),(3,13,2,'신촌맛집'),(4,2,0,'신촌맛집');
...
INSERT INTO `emblem` VALUES ('article100','../img/emblem/moon.png','100 그릇 식사를 하셨습니다.'),('chicken','../img/emblem/chicken.png','음~ 치킨'),('firstArticle','../img/emblem/confetti.png','첫 기사 등록에 감사합니다.'),('firstRest','../img/emblem/confetti.png','첫 식당 등록에 감사합니다.'),('hundredArticles','../img/emblem/hundred.png','100번쩨 기사 등록을 축하합니다.'),('hundredRests','../img/emblem/hundred.png','100번쩨 식당 등록을 축하합니다.'),('meat','../img/emblem/meat.png','육식성'),('noodle','../img/emblem/noodle.png','면 요리를 엄청 좋아하시나 봐요.'),('rest100','../img/emblem/star.png','식당 100개를 입력하셨습니다.'),('signin','../img/emblem/confetti.png','회원가입을 축하합니다.');
...
INSERT INTO `emblem_achive` VALUES ('rwyA5DgoUnKc','firstRest'),('2XlRehENs3kP','signin');
...
CREATE TABLE `emblem_member` (
  ...
  `eat_meat` int(11) DEFAULT '0',
  `eat_chicken` int(11) DEFAULT '0',
  PRIMARY KEY (`uid`),
...
INSERT INTO `emblem_member` VALUES ('2XlRehENs3kP',0,0,0),('75FTQ69HMRYd',0,0,0),('7k0OieLy05Ni',0,0,0),('rwyA5DgoUnKc',1,1,0);
...
-- Dump completed on 2017-11-21 17:39:13
