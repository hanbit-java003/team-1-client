...
CREATE TABLE `cc_member` (
  ...
  `leave` varchar(45) NOT NULL DEFAULT 'N',
  PRIMARY KEY (`uid`),
...
INSERT INTO `cc_rest_detail` VALUES (0,'서울특별시 서대문구 신촌동 연세로5길 26-7','02-3141-9494','11:00 ~ 15:00, 17:00 ~ 21:00','차돌 양지 쌀국수','영업'),(1,'서울특별시 서대문구 신촌동 신촌로 87-4','02-3144-3967','오전 11:00 ~ 오후 11:30','가케우동','영업'),(2,'서울 서대문구 신촌로 87-22','02-336-2069','00:00 - 24:00','왕순대국밥','영업'),(3,'서울특별시 마포구 백범로 23 (신수동)','02-704-9667','11:00 - 21:00','간짜장','영업'),(4,'서울 서대문구 연세로11길 12','02-326-5830','11:00 ~ 21:00 일요일 휴무','치즈듬뿍 함박','영업'),(5,'서울특별시 마포구 백범로1길 8-7(노고산동, 31-50) 지하 1층','02-701-0890','오전 10:00~오후 11:30','거북이 카레','영업'),(6,'서울특별시 마포구 노고산동 54-80','02-336-8599','12:00 ~ 21:00 월,화 휴무','고라멘','영업'),(7,'서울특별시 서대문구 창천동 53-19','02-324-9200','16:00 - 02:00','핫치킨','영업'),(8,'서울특별시 서대문구 창천동 53-8','02-324-1403','오전 11:00~오후 10:00','고등어구이','영업'),(9,'서울 서대문구 연세로 10','02-393-7772','11:00 - 22:00','대왕돈까스','영업'),(10,'서울특별시 마포구 대흥동 백범로 36','02-2604-2300','10:00 ~ 20:30 일요일 휴무','돼지불백','영업'),(11,'서울특별시 마포구 노고산동 33-19','02-703-8231','오전 11:00~오후 10:00','유케동','영업'),(12,'서울특별시 서대문구 신촌동 연세로4길 19','02-312-2833','오전 11:00~오후 9:00','갑이다짬뽕','영업'),(13,'서울 서대문구 연세로2길 93-7','02-6401-7793','11:30 - 15:00, 17:30 - 22:00','뿌팟퐁커리','영업');
...
--
-- Dumping routines for database 'cock_cock'
--
...
-- Dump completed on 2017-11-16 12:43:53
